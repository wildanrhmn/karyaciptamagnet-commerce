  ...
  const renderItem = (index: number) => {
    ...
    return (
      ...
      >
        ...
        {/* BG */}
        <div className="absolute inset-0 bg-[#e3ebff]">
          <Image
            fill
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          >
            ...
            <ButtonPrimary
              ...
              href={item.btnLink}
            >
              <span className="text-[#F9FAFB]">{item.btnText}</span>
              <span>
                <svg className="w-5 h-5 ms-2.5 dark:text-[#F9FAFB]" viewBox="0 0 24 24" fill="none">
                  <path
