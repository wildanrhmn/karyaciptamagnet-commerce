...
export default function Footer() {
  return (
    <footer className="dark:bg-dark relative z-10 bg-slate-800 pb-10 pt-20 text-white lg:pb-20 lg:pt-[120px]">
      <div className="container">
        <div className="mx-4 flex flex-wrap">
          <div className="sm:w-3/3 w-full px-4 lg:w-4/12">
            <div className="mb-10 w-full">
              <Link href="/#" className="mb-6 inline-block max-w-[160px]">
                <Image src="/logo.png" height={100} width={100} alt="Flowmazon logo" />
              </Link>
              <p className="text-body-color dark:text-dark-6 mb-7 text-base">
                CV. Karya Cipta Magnet (KCM) adalah Specialist Permanent Magnet
                Trap yang berada di Kec Gunung sindur, Bogor, Jawa Barat.
              </p>
              <p className="text-dark flex items-center text-sm font-medium dark:text-white">
                ...
                <span>+62 251 8565 088</span>
              </p>
            </div>
          </div>
          <LinkGroup header="Organisasi">
            <NavLink link="/#" label="Tentang Kami" />
            <NavLink link="/#" label="Kontak & Bantuan" />
            <NavLink link="/#" label="Sejarah Kesuksesan" />
            <NavLink link="/#" label="Kebijikan Privasi" />
          </LinkGroup>
          <LinkGroup header="Link Lain">
            <NavLink link="/#" label="WhatsApp" />
            <NavLink link="/#" label="Kinerja Kami" />
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color dark:text-dark-6 text-base">
                &copy; 2025 CV. Karya Cipta Magnet
              </p>
            </div>
          </div>
        </div>
