...
const TabFilters = () => {
  ...
  const [rangePrices, setRangePrices] = useState([100000, 5000000]);
        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2 min-w-[90px]">{`Rp. ${rangePrices[0].toLocaleString(
                "id-ID"
              )} - Rp. ${rangePrices[1].toLocaleString("id-ID")}`}</span>
              {rangePrices[0] === MINMAX_PRICE_RANGE[0] &&
              rangePrices[1] === MINMAX_PRICE_RANGE[1] ? null : (
                <span onClick={() => setRangePrices(MINMAX_PRICE_RANGE)}>
                  {renderXClear()}
                </span>
              )}
            </Popover.Button>
                ...
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  <div className="relative flex flex-col px-5 py-6 space-y-8">
                    <div className="space-y-5">
                      <span className="font-medium">Range harga</span>
                      <Slider
                        range
                        min={MINMAX_PRICE_RANGE[0]}
                        max={MINMAX_PRICE_RANGE[1]}
                        step={1}
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    <ButtonThird
                      onClick={() => {
                        setRangePrices(MINMAX_PRICE_RANGE);
                        close();
                      }}
                      sizeClass="px-4 py-2 sm:px-5"
                    >
                ...
                <div className="inline-flex flex-col w-full text-left align-middle transition-all transform bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100 h-full">
                  ...
                  <div className="flex-grow overflow-y-auto">
                    <div className="px-6 sm:px-8 md:px-10 divide-y divide-neutral-200 dark:divide-neutral-800">
                      ...
                      {/* ---- */}
                      <div className="py-7">
                        <h3 className="text-xl font-medium">Range Harga</h3>
                        <div className="mt-6 relative ">
                              ...
                              <div>
                                ...
                                <div className="mt-1 relative rounded-md">
                                  ...
                                  <input
                                    ...
                                    disabled
                                    id="minPrice"
                                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-8 pr-3 sm:text-sm border-neutral-200 rounded-full text-neutral-900"
                                    value={rangePrices[0].toLocaleString(
                                      "id-ID"
                                    )}
                                  />
                                </div>
                              ...
                              <div>
                                ...
                                <div className="mt-1 relative rounded-md">
                                  ...
                                  <input
                                    ...
                                    id="maxPrice"
                                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-8 pr-3 sm:text-sm border-neutral-200 rounded-full text-neutral-900"
                                    value={rangePrices[1].toLocaleString(
                                      "id-ID"
                                    )}
                                  />
                                </div>
