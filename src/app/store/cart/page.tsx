...
export const metadata = {
  title: "Keranjang Belanja - Karya Cipta Magnet",
};
...
export default async function CartPage() {
  ...
  if(!cart){
    return(
      <div className="h-screen bg-white rounded-xl pt-20">
  ...
  return (
    <div className="h-screen bg-white rounded-xl pt-20">
      <h1 className="mb-10 text-center text-2xl font-bold">Keranjang Anda</h1>
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div className="rounded-lg md:w-2/3">
          ...
          <hr className="py-1 px-11" />
          <div className="mb-6 justify-between rounded-lg bg-white p-6 sm:flex sm:justify-start">
            <img
