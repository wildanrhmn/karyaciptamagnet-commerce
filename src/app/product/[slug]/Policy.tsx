...
const A_FEATURES = [
  {
    ...
    desc: "Untuk pesanan di atas 750.000 IDR",
  ...
  {
    color: "bg-sky-50",
    name: "Pengembalian Mudah",
    desc: "Cukup dengan nomor telepon.",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    desc: "60 hari pengembalian untuk alasan apapun",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
